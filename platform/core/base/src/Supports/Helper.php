...
class Helper
{
    ...
    {
        $districts = config('core.base.general.countries', []);

        $translatedDistricts = array_change_key_case(trans('core/base::districts', []), CASE_UPPER);

        return array_map('html_entity_decode', [...$districts, ...$translatedDistricts]);
    }
