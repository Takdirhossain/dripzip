    ...
    public function boot(): void
    {
            ...
            switch ($request->input('payment_method')) {
                ...
                case PaymentMethodEnum::BANK_TRANSFER:
                    ...
                    if ($minimumOrderAmount > Cart::instance('cart')->rawSubTotal()) {
                        $data['error'] = true;
                        $data['message'] = __(
                            'Minimum order amount to use Bkash payment method is :amount, you need to buy more :more to place an order!',
                            [
                                'amount' => format_price($minimumOrderAmount),
                                'more' => format_price($minimumOrderAmount - Cart::instance('cart')->rawSubTotal()),
                            ]
        ...
        if (defined('PAYMENT_FILTER_PAYMENT_INFO_DETAIL')) {
            add_filter(PAYMENT_FILTER_PAYMENT_INFO_DETAIL, function ($data, $payment) {
                ...
                $proofHtml = view('plugins/ecommerce::orders.partials.payment-proof-detail', compact('order'))->render();
