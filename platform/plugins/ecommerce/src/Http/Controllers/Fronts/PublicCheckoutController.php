...
class PublicCheckoutController extends BaseController
{
    ...
    public function postSaveInformation(
        ...
        if ($paymentMethod = $request->input('payment_method') === 'bank_transfer' ? 'bkash' : $request->input('payment_method') ) {
    ...
    public function postCheckout(
        ...
        $paymentMethod = $request->input('payment_method') === 'bank_transfer' ? 'bkash' : $request->input('payment_method', session('selected_payment_method'));
        if ($paymentMethod) {
            session()->put('selected_payment_method', $paymentMethod);
        }
        ...
        $shippingMethodInput = $request->input('shipping_method') == 'bank_transfer' ? 'bkash' : $request->input('shipping_method');
        $shippingOption = $request->input('shipping_option');
        ...
        $paymentData = [
            ...
            'type' => $request->input('payment_method') == 'bank_transfer' ? 'bkash' : $request->input('payment_method'),
            'charge_id' => null,
        ];
