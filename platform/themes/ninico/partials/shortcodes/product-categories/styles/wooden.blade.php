                ...
                <div class="tpcategory mb-40">
                    <a href="{{ $category->url }}">
                        <div class="tpcategory__icon p-relative">
                            ...
                            @else
                            <div>
                                <img style="min-width: 130px !important; min-height: 130px; object-fit: cover; border-radius: 50%;" src="{{ RvMedia::getImageUrl($category->image, default: RvMedia::getDefaultImage()) }}" alt="{{ $category->name }}">
