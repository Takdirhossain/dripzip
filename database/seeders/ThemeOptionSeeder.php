...
class ThemeOptionSeeder extends BaseSeeder
{
    ...
    public function run(): void
    {
        ...
        $this->createThemeOptions([
            'site_title' => 'Banglar Shomiron - Minimal eCommerce',
            'seo_description' => 'Banglar Shomiron is a modern and flexible Minimal eCommerce Laravel script. This script is suited for electronic, organic and grocery store, furniture store, clothing store, hitech store and accessories store...',
